...
class Base_Agent(object):
    ...
    def __init__(self, config):
        ...
        self.environment: GEPEnv = config.environment
    ...
    def save_result(self):
        ...
        self.game_full_episode_scores.append(self.total_episode_score_so_far / self.batch_size)
    ...
    def create_NN(self, input_dim, output_dim, key_to_use=None, override_seed=None, hyperparameters=None):
        ...
        layers_info = eval(hyperparameters["linear_hidden_units"])
        if layers_info == [64, 64]:
            return Net(output_dim=output_dim).to(self.device)
        else:
